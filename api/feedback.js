...
# 長さ（材料の量に応じて可変・最重要）
・自由記述が具体的で情報量が多いほど、その内容に深く踏み込んで長く書く（目安15〜20行、最大22行程度）。短くまとめない。
・自由記述が空・短い・薄い場合のみ、無理に伸ばさず8〜10行で簡潔にまとめる。
...
{"summary":"5〜6文。回答を根拠に、平易で具体的に。冒頭から引き込み、最後の文は途中で切られても惜しいと思える濃い内容にする（LINE登録前にこの一部だけ見せるため）。","values":[],"message":"材料に応じて、自由記述が濃ければ15〜20行で厚く。薄い水増しは禁止。改行は\\nで表現。","bridge":"この経営層と話す価値を具体的な1文で。"}`;
...
# 長さ（材料の量に応じて可変）
・自由記述・メモが具体的なほど深く踏み込んで長く書く（目安15〜20行、最大22行程度）。短くまとめない。
・自由記述が空・薄い場合のみ8〜10行で簡潔に。水増し（言い換え・一般論）は禁止。常に本人の選択・言葉に紐づける。
